#pragma once
#include "duckdb.hpp"
#include "duckdb/parser/parsed_date/create_info.hpp"
...
namespace esql {
    ...
    class CreateModelStatement : public SQLStatement {
        public:
            CreateModelStatement() : SQLStatement(StatementType::EXTENTION_STATEMENT) {}
            ...
            sd::string scaling_method = "standard";
        ...
        public:
            ...
            std::unique_ptr<SQLStatement> copy() const override;
